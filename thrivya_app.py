...
if st.session_state.page == "intro":
    ...
    with st.form("culture_form"):
        ...
        for i, q in enumerate(questions_culture):
            responses[q['id']] = show_enhanced_slider(q, i, len(questions_culture), "#ff6b6b")
    ...
    with st.form("wellness_form"):
        ...
        for i, q in enumerate(questions_wellness):
            responses[q['id']] = show_enhanced_slider(q, i, len(questions_wellness), "#4ecdc4")
        st.session_state.responses.update(responses)
    ...
    with st.form("growth_form"):
        ...
        for i, q in enumerate(questions_growth):
            responses[q['id']] = show_enhanced_slider(q, i, len(questions_growth), "#45b7d1")
        st.session_state.responses.update(responses)
